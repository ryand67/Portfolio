    ...
    return (
        <main className="workPage">
            ...
            <div className="workGallery workGalleryBottom">
                ...
                <WorkCard imgSrc={work4} deployed="http://tsg-live-preview.herokuapp.com/" title="TravelSalesGroup" gitHub="https://github.com/ryand67/TSG-Site" desc="[Under Construction] A site to promote the services of the travel agency TravelSalesGroup." />
            </div>
        </main>
    )
}
